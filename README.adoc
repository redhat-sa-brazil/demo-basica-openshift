...
def projectSet(String project, String ocpurl, String token) {
	sh "oc login -u admin -p admin ${ocpurl}"
	sh "oc login --insecure-skip-tls-verify=true https://master.rhpds311.openshift.opentlc.com:443 --token=${token}"
    sh "oc new-project ${project} || echo 'Project exists'"
    sh "oc project ${project}"
}

def deploy(String origProject, String project, String app, String env, String ocpurl, String token){
    projectSet(project, ocpurl, token)
